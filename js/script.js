...
(function() {
  var depth, easeOutQuart, easing, goCrazy, pageHeight, pageWidth, parallaxWidth, planes, prevX, resize, sgn, tiltHeight, tiltWidth, transformKey, update, updatePlane,
    __hasProp = {}.hasOwnProperty;

  easeOutQuart = function(d) {
    return function(t) {
      return 1 - Math.pow(t / d - 1, 4);
    };
  };
